...
@Reducer
struct EditRecipeReducer: Sendable {
  typealias State = EditRecipeState
  typealias Action = EditRecipeAction
...
@ObservableState
struct EditRecipeState: Sendable, Equatable {
...
@CasePathable
enum EditRecipeAction: Sendable, Equatable, BindableAction {
  case binding(BindingAction<EditRecipeState>)
