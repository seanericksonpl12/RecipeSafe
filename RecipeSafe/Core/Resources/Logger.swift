...
class Logger {
  ...
  enum Category {
    case network, security, `default`, database
  }
  ...
  private static let databaseLog = OSLog(subsystem: Bundle.main.bundleIdentifier ?? "App.DefaultSubSystem", category: "Database")
